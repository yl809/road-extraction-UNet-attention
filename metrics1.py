...
if __name__ == '__main__':
    ...
    image1 = cv2.imread('./results/0_label.png', cv2.IMREAD_GRAYSCALE)
    image2 = cv2.imread('./results/0_pred.png', cv2.IMREAD_GRAYSCALE)
    print(iou_coef(image1, image2))
    print(dice_coef(image1, image2))